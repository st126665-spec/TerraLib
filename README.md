...
## TerraLib (New CLI-style MQTT subset)

A new from-scratch MQTT client has been added in `src/TerraLib.h` and `src/TerraLib.cpp`.
...
- Test case: `tests/testcases/terrabasic.py` (broker-based integration smoke test)

### TerraLib example notes

1. Update WiFi credentials and broker host in `examples/terrabasic/terrabasic.ino`.
